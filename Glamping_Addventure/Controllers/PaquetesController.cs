...
namespace Glamping_Addventure.Controllers
{
    public class PaquetesController : Controller
    {
        ...
        public PaquetesController(GlampingAddventuresContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Create()
        {
            ...
            var serviciosDisponibles = _context.Servicios
                     .Where(s => !_context.Paquetes.Any(p=> p.Idservicio == s.Idservicio) && s.Estado).ToList();
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            return PartialView("_DeletePartial", paquete);
        }
