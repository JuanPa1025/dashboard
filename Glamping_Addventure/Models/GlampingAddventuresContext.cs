...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MEDAPRCSGFSP691\\SQLEXPRESS;Initial Catalog=Glamping_Addventures;integrated security=True; TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Abono>(entity =>
        {
            entity.HasKey(e => e.Idabono).HasName("PK__Abono__8647F8A9D3BFA413");
        ...
        {
            entity.HasKey(e => e.NroDocumento).HasName("PK__Clientes__CC62C91C76C0AEFA");
        ...
        {
            entity.HasKey(e => e.IddetalleReservaPaquetes).HasName("PK__DetalleR__64F9FDAE5A1569F0");
        ...
        {
            entity.HasKey(e => e.IddetalleReservaServicio).HasName("PK__DetalleR__B52B22F8607EA6BA");
        ...
        {
            entity.HasKey(e => e.IdEstadoReserva).HasName("PK__EstadosR__3E654CA812638A87");
        ...
        {
            entity.HasKey(e => e.Idhabitacion).HasName("PK__Habitaci__6B4757DAB0379660");
        ...
        {
            entity.HasKey(e => e.IdhabitacionMuebles).HasName("PK__Habitaci__65CFCA9A27B18B1E");
        ...
        {
            entity.HasKey(e => e.IdMetodoPago).HasName("PK__MetodoPa__6F49A9BE416BB720");
        ...
        {
            entity.HasKey(e => e.Idmueble).HasName("PK__Muebles__EAC9F7C8C2D9B760");
        ...
        {
            entity.HasKey(e => e.Idpaquete).HasName("PK__Paquetes__4C29513BF5DF647D");
        ...
        {
            entity.HasKey(e => e.Idpermiso).HasName("PK__Permisos__F11D75F34723F251");
        ...
        {
            entity.HasKey(e => e.IdReserva).HasName("PK__Reserva__0E49C69DEF34530C");
        ...
        {
            entity.HasKey(e => e.Idrol).HasName("PK__Roles__A681ACB601E3864C");
        ...
        {
            entity.HasKey(e => e.IdrolPermiso).HasName("PK__RolesPer__3F09FABF68B4C6C1");
        ...
        {
            entity.HasKey(e => e.Idservicio).HasName("PK__Servicio__3CCE7416632D49C8");
        ...
        {
            entity.HasKey(e => e.IdtipodeHabitacion).HasName("PK__TipodeHa__9BD4086CDF9765A9");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__TokenRec__3214EC079F0C2803");
        ...
        {
            entity.HasKey(e => e.Idusuario).HasName("PK__Usuarios__523111691996DD5E");
